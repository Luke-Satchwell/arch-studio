...
const Footer = () => {
  return (
    <footer className="mt-[132px] md:mt-[200px] relative lg:left-[10%] flex flex-col md:flex-row items-center md:w-[612px] xl:w-[1110px]">
      <div className="h-[120px] xl:h-[200px] w-[120px] xl:w-[200px] bg-zinc-900 flex items-center justify-center relative z-10 mb-[-60px] md:mb-0 ">
      ...
      <div className="bg-gray-100 h-[383px] md:h-[120px] xl:h-[200px] md:pl-10 xl:pl-[85px] flex items-center justify-center md:justify-start w-full md:w-[492px] xl:w-[984px] relative">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-[61px] absolute top-[93px] md:relative md:top-0">
          {navLinks.map((link) => (
            <Link
              href={link.to}
              key={link.text}
              className="font-bold text-gray-500 capitalize hover:text-zinc-900 cursor-pointer"
            >
              {link.text}
            </Link>
          ))}
        ...
        <Link
          href="/portfolio"
          className="absolute md:left-[400px] xl:left-[800px] bottom-[48px] md:bottom-6 xl:bottom-16"
        >
          <button className="bg-zinc-900 hover:bg-neutral-500 cursor-pointer h-[72px] w-[252px] text-white capitalize flex items-center justify-center gap-6">
            See our portfolio
            <AiOutlineArrowRight />
          </button>
        </Link>
